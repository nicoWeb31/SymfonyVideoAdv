...
class __TwigTemplate_7b0b408968b99ad23600ec2a35c8467332ccb191d8eddba8dfeb654c5b80ead6 extends Template
{
    private $source;
    private $macros = [];
...
{% for category in categories %}
    <a class=\"p-2 text-dark\" href=\"{{path('video_list',{categoryname : category.name|lower, 'id':category.id })}}\">{{category.name}}</a>
