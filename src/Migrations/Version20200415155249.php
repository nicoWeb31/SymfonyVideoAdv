 ...
 */
final class Version20200415155249 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE categotries ADD CONSTRAINT FK_4587BCAA727ACA70 FOREIGN KEY (parent_id) REFERENCES categotries (id)');
